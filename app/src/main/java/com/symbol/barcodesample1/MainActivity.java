...
public class MainActivity extends Activity implements EMDKListener, DataListener, StatusListener, ScannerConnectionListener, OnCheckedChangeListener {
    ...
    public class SendTextTask extends AsyncTask<String, Void, Void>{
        ...
        protected Void doInBackground(String... strings) {
            ...
            try {
                ...
                // Crea un objeto PrintWriter para enviar texto
    ...
    public void sendRawTextToNvr(String code){
        SendTextTask sendTextTask = new SendTextTask();
        sendTextTask.execute("192.168.100.129", "14002", code);
